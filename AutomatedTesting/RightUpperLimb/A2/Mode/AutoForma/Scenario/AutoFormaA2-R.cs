...
public partial class FullAutoFormaA2R
{
    private AltDriver altDriver;
    private AutoFormaHelpersA2R helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersA2R(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaA2RWorkflow()
    {
        ExecuteFitLevel();
