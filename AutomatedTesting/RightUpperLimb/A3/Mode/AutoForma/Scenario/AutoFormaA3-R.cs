...
public partial class FullAutoFormaA3R
{
    ...
    private AutoFormaHelpersA3R helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersA3R(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaA3RWorkflow()
    {
        ExecuteFitLevel();
