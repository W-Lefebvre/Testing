...
public partial class FullScanCorrectionA4R
{
    private AltDriver altDriver;
    private ScanCorrectionHelpersA4R helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: "192.168.1.13", port: 13000, appName: "__default__");        helpers = new ScanCorrectionHelpersA4R(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullScanCorrectionThumbWorkflow()
    {
        ExecuteCleanupLevel();
        ExecutePoseLevel();
        ExecuteThumbLevel();
    ...
    private void ExecuteFullCleanupLevel()
    {
        helpers.ClickCleanupBtnMainViewObject();
        helpers.ClickConfirmBtnPopUpObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.SelectPartOfScanText);
        helpers.ClickSelectPartOfInterestArmRightA2();
        helpers.ClickQuitBtnObject();
        helpers.VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.ModificationsWillBeLostText);
        helpers.ClickConfirmBtnPopUpObject();
        helpers.ClickCleanupBtnMainViewObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.SelectPartOfScanText);
        helpers.ClickSelectPartOfInterestArmRightA2();
        helpers.ClickNextStepBtnObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PositionLandmarkText);
        helpers.VerifyAndAssertText("/Cleanup/LMRunPlacementStep(Clone)/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.WristCreaseCenterText);
        ...
        SetCleanupLandmarks();
        helpers.ClickPreviousStepBtnObject();
        helpers.VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.OldLandmarksOrSetAgainText);
        helpers.ClickKeepBtnLandmarksPopUpObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.SelectPartOfScanCropOffText);
        helpers.CuttingPlanePositionObject();
        helpers.ClickVerticalAngleBtnObject();
        helpers.MoveVerticalSliderCuttingPlanePositionObject();
        helpers.ClickVerticalAngleBtnObject();
        ...
        helpers.CuttingPlanePositionObject();
        helpers.ClickNextStepBtnObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.CheckConfirmScanText);
        helpers.ClickPreviousStepBtnObject();
        helpers.CuttingPlanePositionObject();
        helpers.ClickNextStepBtnObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.CheckConfirmScanText);
    ...
    private void SetCleanupLandmarks()
    {
        ...
        helpers.VerifyAndAssertText("/Cleanup/LMRunPlacementStep(Clone)/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.VentralArmText);
    ...
    private void ExecutePoseLevel()
    {
        ...
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PosingModeSelectionText);
        //ClickQuitBtnPoseObject();
        //VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.ModificationsWillBeLostText);
        //ClickConfirmBtnPopUpObject();
        //ClickPoseBtnMainViewObject();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PosingModeSelectionText);
        //ClickAdvancedPoseBtnObject();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PositionLandmarkText);
        //VerifyAndAssertText("/Pose/LMRunPlacementStep(Clone)/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.ThumbTipText);
        //SetPoseLandmarks();
        //PerformRepeatedClicks(ClickBackArrowBtnPoseObject, 12);
        //PerformRepeatedClicks(ClickTickBtnPoseObject, 13);
        //BeingProcessed();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.CheckTheLimbPoseText);
        //ClickPreviousStepBtnPoseObject();
        //VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.OldLandmarksOrSetAgainText);
        ...
        //ClickPoseBtnMainViewObject();
        //VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.AllChangesLostText);
        //ClickConfirmBtnPopUpObject();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PosingModeSelectionText);
        //ClickAdvancedPoseBtnObject();
        //VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.OldLandmarksOrSetAgainText);
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PosingModeSelectionText);
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PositionLandmarkText);
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.ThumbTipText);
        SetPoseLandmarks();
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.CheckTheLimbPoseText);
        ...
        helpers.ClickPoseBtnMainViewObject();
        helpers.VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.AllChangesLostText);
        helpers.ClickConfirmBtnPopUpObject();
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PosingModeSelectionText);
        helpers.ClickAdvancedPoseBtnObject();
        helpers.VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.OldLandmarksOrSetAgainText);
    ...
    private void SetPoseLandmarks()
    {
        ...
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.DistalEndIndexFingerText);
        helpers.ClickDistalEndIndexLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.DistalEndMiddleFingerText);
        helpers.ClickDistalMiddleFingerLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.DistalEndRingFingerText);
        helpers.ClickDistalRingFingerLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.DistalEndLittleFingerText);
        helpers.ClickDistalLittleFingerLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.ThumbMetacarpalText);
        helpers.ClickThumbMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.IndexMetacarpalText);
        helpers.ClickIndexMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.MiddleMetacarpalText);
        helpers.ClickMiddleMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.RingMetacarpalText);
        helpers.ClickRingMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.LittleMetacarpalText);
        helpers.ClickLittleMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.MetacarpalCreaseCenterText);
        helpers.ClickCreaseCenterMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.MedialBorderMetacarpalText);
        helpers.ClickMedialBorderMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.WristCreaseCenterText);
    ...
    private void ExecuteThumbLevel()
    {
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PositionLandmarkText);
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.ThumbInterPhalangealText);
        ...
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.ThumbMetacarpalText);
        helpers.ClickBackArrowBtnThumbObject();
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.ThumbInterPhalangealText);
        helpers.PerformRepeatedClicks(helpers.ClickTickBtnThumbObject, 3);
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.CheckTheThumbText);
        ...
        helpers.VerifyAndAssertText("/Canvas/ThumbEditorPanel(Clone)/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.ThumbEditorPanelText);
    ...
    private void SetThumbLandmarks()
    {
        ...
        helpers.ClickTickBtnThumbObject();
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.FirstInterdigitalText);
    ...
    private void ExecuteSculptLevel()
    {
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.SculptEditorText);
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.SculptValidationText);
        helpers.ClickPreviousStepBtnSculptObject();
        helpers.VerifyAndAssertText("/Canvas/SculptUI(Clone)/InteractiveUIRoot/Pull Push  Switch/Labels/Label On", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PullOptionActivated);
        helpers.ClickPullPushBtnSculptObject();
        helpers.ClickNextStepBtnSculptObject();
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.SculptValidationText);
        helpers.ClickPreviousStepBtnSculptObject();
        helpers.VerifyAndAssertText("/Canvas/SculptUI(Clone)/InteractiveUIRoot/Pull Push  Switch/Labels/Label Off", FullScanCorrectionA4R.ScanCorrectionHelpersA4R.PushOptionActivated);
        helpers.ClickOnAxisYSculptObject();
        Thread.Sleep(1000);
