...
public partial class FullAutoFormaA4R
{
    private AltDriver altDriver;
    private AutoFormaHelpersA4R helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersA4R(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaA4RWorkflow()
    {
        ExecuteFitLevel();
