...
public partial class FullScanCorrectionW2R
{
    private AltDriver altDriver;
    private ScanCorrectionHelpersW2R helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: "192.168.1.13", port: 13000, appName: "__default__");        helpers = new ScanCorrectionHelpersW2R(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullScanCorrectionW2Workflow()
    {
        ExecuteCleanupLevel();
        ExecutePoseLevel();
        ExecuteThumbLevel();
    ...
    private void ExecuteFullCleanupLevel()
    {
        helpers.ClickCleanupBtnMainViewObject();
        helpers.ClickConfirmBtnPopUpObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.SelectPartOfScanText);
        helpers.ClickSelectPartOfInterestArmRightA2();
        helpers.ClickQuitBtnObject();
        helpers.VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.ModificationsWillBeLostText);
        helpers.ClickConfirmBtnPopUpObject();
        helpers.ClickCleanupBtnMainViewObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.SelectPartOfScanText);
        helpers.ClickSelectPartOfInterestArmRightA2();
        helpers.ClickNextStepBtnObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PositionLandmarkText);
        helpers.VerifyAndAssertText("/Cleanup/LMRunPlacementStep(Clone)/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.WristCreaseCenterText);
        ...
        SetCleanupLandmarks();
        helpers.ClickPreviousStepBtnObject();
        helpers.VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.OldLandmarksOrSetAgainText);
        helpers.ClickKeepBtnLandmarksPopUpObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.SelectPartOfScanCropOffText);
        helpers.CuttingPlanePositionObject();
        helpers.ClickVerticalAngleBtnObject();
        helpers.MoveVerticalSliderCuttingPlanePositionObject();
        helpers.ClickVerticalAngleBtnObject();
        ...
        helpers.CuttingPlanePositionObject();
        helpers.ClickNextStepBtnObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.CheckConfirmScanText);
        helpers.ClickPreviousStepBtnObject();
        helpers.CuttingPlanePositionObject();
        helpers.ClickNextStepBtnObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.CheckConfirmScanText);
    ...
    private void SetCleanupLandmarks()
    {
        ...
        helpers.VerifyAndAssertText("/Cleanup/LMRunPlacementStep(Clone)/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.VentralArmText);
    ...
    private void ExecutePoseLevel()
    {
        ...
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PosingModeSelectionText);
        //ClickQuitBtnPoseObject();
        //VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.ModificationsWillBeLostText);
        //ClickConfirmBtnPopUpObject();
        //ClickPoseBtnMainViewObject();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PosingModeSelectionText);
        //ClickAdvancedPoseBtnObject();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PositionLandmarkText);
        //VerifyAndAssertText("/Pose/LMRunPlacementStep(Clone)/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.ThumbTipText);
        //SetPoseLandmarks();
        //PerformRepeatedClicks(ClickBackArrowBtnPoseObject, 12);
        //PerformRepeatedClicks(ClickTickBtnPoseObject, 13);
        //BeingProcessed();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.CheckTheLimbPoseText);
        //ClickPreviousStepBtnPoseObject();
        //VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.OldLandmarksOrSetAgainText);
        ...
        //ClickPoseBtnMainViewObject();
        //VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.AllChangesLostText);
        //ClickConfirmBtnPopUpObject();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PosingModeSelectionText);
        //ClickAdvancedPoseBtnObject();
        //VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.OldLandmarksOrSetAgainText);
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PosingModeSelectionText);
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PositionLandmarkText);
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.ThumbTipText);
        SetPoseLandmarks();
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.CheckTheLimbPoseText);
        ...
        helpers.ClickPoseBtnMainViewObject();
        helpers.VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.AllChangesLostText);
        helpers.ClickConfirmBtnPopUpObject();
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PosingModeSelectionText);
        helpers.ClickAdvancedPoseBtnObject();
        helpers.VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.OldLandmarksOrSetAgainText);
    ...
    private void SetPoseLandmarks()
    {
        ...
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.DistalEndIndexFingerText);
        helpers.ClickDistalEndIndexLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.DistalEndMiddleFingerText);
        helpers.ClickDistalMiddleFingerLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.DistalEndRingFingerText);
        helpers.ClickDistalRingFingerLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.DistalEndLittleFingerText);
        helpers.ClickDistalLittleFingerLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.ThumbMetacarpalText);
        helpers.ClickThumbMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.IndexMetacarpalText);
        helpers.ClickIndexMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.MiddleMetacarpalText);
        helpers.ClickMiddleMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.RingMetacarpalText);
        helpers.ClickRingMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.LittleMetacarpalText);
        helpers.ClickLittleMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.MetacarpalCreaseCenterText);
        helpers.ClickCreaseCenterMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.MedialBorderMetacarpalText);
        helpers.ClickMedialBorderMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.WristCreaseCenterText);
    ...
    private void ExecuteThumbLevel()
    {
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PositionLandmarkText);
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.ThumbInterPhalangealText);
        ...
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.ThumbMetacarpalText);
        helpers.ClickBackArrowBtnThumbObject();
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.ThumbInterPhalangealText);
        helpers.PerformRepeatedClicks(helpers.ClickTickBtnThumbObject, 3);
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.CheckTheThumbText);
        ...
        helpers.VerifyAndAssertText("/Canvas/ThumbEditorPanel(Clone)/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.ThumbEditorPanelText);
    ...
    private void SetThumbLandmarks()
    {
        ...
        helpers.ClickTickBtnThumbObject();
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.FirstInterdigitalText);
    ...
    private void ExecuteSculptLevel()
    {
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.SculptEditorText);
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.SculptValidationText);
        helpers.ClickPreviousStepBtnSculptObject();
        helpers.VerifyAndAssertText("/Canvas/SculptUI(Clone)/InteractiveUIRoot/Pull Push  Switch/Labels/Label On", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PullOptionActivated);
        helpers.ClickPullPushBtnSculptObject();
        helpers.ClickNextStepBtnSculptObject();
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.SculptValidationText);
        helpers.ClickPreviousStepBtnSculptObject();
        helpers.VerifyAndAssertText("/Canvas/SculptUI(Clone)/InteractiveUIRoot/Pull Push  Switch/Labels/Label Off", FullScanCorrectionW2R.ScanCorrectionHelpersW2R.PushOptionActivated);
        helpers.ClickOnAxisYSculptObject();
        Thread.Sleep(1000);
