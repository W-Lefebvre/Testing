...
public partial class FullScanCorrectionB5R
{
    public class ScanCorrectionHelpersB5R
    {
        private AltDriver altDriver;

        public ScanCorrectionHelpersB5R(AltDriver driver)
        {
            altDriver = driver;
        }
        ...
        public void ClickSelectPartOfInterestLegRightB2() => Click(989.8507f, 986.894f);
        public void ClickMedialMalleolusCenterCleanupLandmark() => Click(1258.283f, 625.7979f);
        public void ClickTibiaMidCleanupLandmark() => Click(1077.424f, 873.5713f);
        public void ClickMetatarsusFirstBonePoseLandmark() => Click(1182.132f, 639.2429f);
