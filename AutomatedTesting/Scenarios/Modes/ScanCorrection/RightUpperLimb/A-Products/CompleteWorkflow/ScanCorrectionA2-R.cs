...
public partial class FullScanCorrectionA2R
{
    private AltDriver altDriver;
    //private ScanCorrectionHelpersA2R helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = AltDriverConfig.GetAltDriver();        
       // helpers = new ScanCorrectionHelpersA2R(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullScanCorrectionA2Workflow()
    {
        VerifyProductCode("A2");
        ExecuteCleanupLevel();
        ExecutePoseLevel();
        ExecuteThumbLevel();
        ExecuteSculptLevel();
    ...
    {
        Helpers.VerifyTextContainsProductCode("/Canvas/BackToOrderPan/Button Navigation/Text (1)", expectedProductCode);
    }
    ...
    private void ExecuteFullCleanupLevel()
    {
        helpers.ClickCleanupBtnMainViewObject();
        helpers.ClickConfirmBtnPopUpObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.SelectPartOfScanText);
        helpers.ClickSelectPartOfInterestArmRightA2();
        helpers.ClickQuitBtnObject();
        helpers.VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.ModificationsWillBeLostText);
        helpers.ClickConfirmBtnPopUpObject();
        helpers.ClickCleanupBtnMainViewObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.SelectPartOfScanText);
        helpers.ClickSelectPartOfInterestArmRightA2();
        helpers.ClickNextStepBtnObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PositionLandmarkText);
        helpers.VerifyAndAssertText("/Cleanup/LMRunPlacementStep(Clone)/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.WristCreaseCenterText);
        ...
        SetCleanupLandmarks();
        helpers.ClickPreviousStepBtnObject();
        helpers.VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.OldLandmarksOrSetAgainText);
        helpers.ClickKeepBtnLandmarksPopUpObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.SelectPartOfScanCropOffText);
        helpers.CuttingPlanePositionObject();
        helpers.ClickVerticalAngleBtnObject();
        helpers.MoveVerticalSliderCuttingPlanePositionObject();
        helpers.ClickVerticalAngleBtnObject();
        ...
        helpers.CuttingPlanePositionObject();
        helpers.ClickNextStepBtnObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.CheckConfirmScanText);
        helpers.ClickPreviousStepBtnObject();
        helpers.CuttingPlanePositionObject();
        helpers.ClickNextStepBtnObject();
        helpers.VerifyAndAssertText("/Cleanup/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.CheckConfirmScanText);
    ...
    private void SetCleanupLandmarks()
    {
        ...
        helpers.VerifyAndAssertText("/Cleanup/LMRunPlacementStep(Clone)/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.VentralArmText);
    ...
    private void ExecutePoseLevel()
    {
        ...
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PosingModeSelectionText);
        //ClickQuitBtnPoseObject();
        //VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.ModificationsWillBeLostText);
        //ClickConfirmBtnPopUpObject();
        //ClickPoseBtnMainViewObject();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PosingModeSelectionText);
        //ClickAdvancedPoseBtnObject();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PositionLandmarkText);
        //VerifyAndAssertText("/Pose/LMRunPlacementStep(Clone)/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.ThumbTipText);
        //SetPoseLandmarks();
        //PerformRepeatedClicks(ClickBackArrowBtnPoseObject, 12);
        //PerformRepeatedClicks(ClickTickBtnPoseObject, 13);
        //BeingProcessed();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.CheckTheLimbPoseText);
        //ClickPreviousStepBtnPoseObject();
        //VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.OldLandmarksOrSetAgainText);
        ...
        //ClickPoseBtnMainViewObject();
        //VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.AllChangesLostText);
        //ClickConfirmBtnPopUpObject();
        //VerifyAndAssertText("/Pose/LevelNavigationPanel(Clone)/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PosingModeSelectionText);
        //ClickAdvancedPoseBtnObject();
        //VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.OldLandmarksOrSetAgainText);
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PosingModeSelectionText);
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PositionLandmarkText);
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.ThumbTipText);
        SetPoseLandmarks();
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.CheckTheLimbPoseText);
        ...
        helpers.ClickPoseBtnMainViewObject();
        helpers.VerifyAndAssertText("/Canvas/WarnPopup(Clone)/Forma Info Panel v3/Content/Content text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.AllChangesLostText);
        helpers.ClickConfirmBtnPopUpObject();
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PosingModeSelectionText);
        helpers.ClickAdvancedPoseBtnObject();
        helpers.VerifyAndAssertText("/Canvas/Popup(Clone)/Content/Content text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.OldLandmarksOrSetAgainText);
    ...
    private void SetPoseLandmarks()
    {
        ...
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.DistalEndIndexFingerText);
        helpers.ClickDistalEndIndexLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.DistalEndMiddleFingerText);
        helpers.ClickDistalMiddleFingerLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.DistalEndRingFingerText);
        helpers.ClickDistalRingFingerLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.DistalEndLittleFingerText);
        helpers.ClickDistalLittleFingerLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.ThumbMetacarpalText);
        helpers.ClickThumbMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.IndexMetacarpalText);
        helpers.ClickIndexMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.MiddleMetacarpalText);
        helpers.ClickMiddleMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.RingMetacarpalText);
        helpers.ClickRingMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.LittleMetacarpalText);
        helpers.ClickLittleMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.MetacarpalCreaseCenterText);
        helpers.ClickCreaseCenterMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.MedialBorderMetacarpalText);
        helpers.ClickMedialBorderMetacarpalLandmark();
        helpers.ClickTickBtnPoseObject();
        helpers.VerifyAndAssertText("/PoseCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.WristCreaseCenterText);
    ...
    private void ExecuteThumbLevel()
    {
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PositionLandmarkText);
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.ThumbInterPhalangealText);
        ...
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.ThumbMetacarpalText);
        helpers.ClickBackArrowBtnThumbObject();
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.ThumbInterPhalangealText);
        helpers.PerformRepeatedClicks(helpers.ClickTickBtnThumbObject, 3);
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.CheckTheThumbText);
        ...
        helpers.VerifyAndAssertText("/Canvas/ThumbEditorPanel(Clone)/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.ThumbEditorPanelText);
    ...
    private void SetThumbLandmarks()
    {
        ...
        helpers.ClickTickBtnThumbObject();
        helpers.VerifyAndAssertText("/ThumbCTL/LMRunPlacementStep/LMRunPlacementStepPanel/Canvas/ImageContainer/Label", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.FirstInterdigitalText);
    ...
    private void ExecuteSculptLevel()
    {
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.SculptEditorText);
        ...
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.SculptValidationText);
        helpers.ClickPreviousStepBtnSculptObject();
        helpers.VerifyAndAssertText("/Canvas/SculptUI(Clone)/InteractiveUIRoot/Pull Push  Switch/Labels/Label On", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PullOptionActivated);
        helpers.ClickPullPushBtnSculptObject();
        helpers.ClickNextStepBtnSculptObject();
        helpers.VerifyAndAssertText("/Canvas/StatusText/Variable Size Container/Text", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.SculptValidationText);
        helpers.ClickPreviousStepBtnSculptObject();
        helpers.VerifyAndAssertText("/Canvas/SculptUI(Clone)/InteractiveUIRoot/Pull Push  Switch/Labels/Label Off", FullScanCorrectionA2R.ScanCorrectionHelpersA2R.PushOptionActivated);
        helpers.ClickOnAxisYSculptObject();
        Thread.Sleep(1000);
