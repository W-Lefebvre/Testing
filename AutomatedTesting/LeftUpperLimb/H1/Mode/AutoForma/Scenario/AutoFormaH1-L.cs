...
public partial class FullAutoFormaH1L
{
    ...
    private AutoFormaHelpersH1L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersH1L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaH1LWorkflow()
    {
        ExecuteFitLevel();
