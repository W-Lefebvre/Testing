...
public partial class FullScanCorrectionA7L
{
    ...
    private ScanCorrectionHelpersA7L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new ScanCorrectionHelpersA7L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullScanCorrectionA7LWorkflow()
    {
        ExecuteCleanupLevel();
        ExecutePoseLevel();
        ExecuteThumbLevel();
    ...
    private void ExecuteCleanupLevel()
    {
        ...
        helpers.ClickSelectPartOfInterestArmLeftA7(); // Cannot use object here, use coordinate.
    ...
    private void ExecuteFullCleanupLevel()
    {
        ...
        helpers.ClickSelectPartOfInterestArmLeftA7();
        helpers.ClickQuitBtnObject();
