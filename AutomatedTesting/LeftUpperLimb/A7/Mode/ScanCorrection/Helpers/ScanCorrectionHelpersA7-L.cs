...
public partial class FullScanCorrectionA7L
{
    public class ScanCorrectionHelpersA7L
    {
        private AltDriver altDriver;

        public ScanCorrectionHelpersA7L(AltDriver driver)
        {
            altDriver = driver;
        }
        ...
        public void ClickSelectPartOfInterestArmLeftA7() => Click(986.0432f, 911.9858f);
