...
public partial class FullScanCorrectionW4L
{
    ...
    private ScanCorrectionHelpersW4L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new ScanCorrectionHelpersW4L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullScanCorrectionW4LWorkflow()
    {
        ExecuteCleanupLevel();
        ExecutePoseLevel();
        ExecuteThumbLevel();
    ...
    private void ExecuteCleanupLevel()
    {
        ...
        helpers.ClickSelectPartOfInterestArmLeftW4(); // Cannot use object here, use coordinate.
    ...
    private void ExecuteFullCleanupLevel()
    {
        ...
        helpers.ClickSelectPartOfInterestArmLeftW4();
        helpers.ClickQuitBtnObject();
