...
public partial class FullScanCorrectionW4L
{
    public class ScanCorrectionHelpersW4L
    {
        private AltDriver altDriver;

        public ScanCorrectionHelpersW4L(AltDriver driver)
        {
            altDriver = driver;
        }
        ...
        public void ClickSelectPartOfInterestArmLeftW4() => Click(986.0432f, 911.9858f);
