...
public partial class FullAutoFormaW4L
{
    ...
    private AutoFormaHelpersW4L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersW4L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaW4LWorkflow()
    {
        ExecuteFitLevel();
