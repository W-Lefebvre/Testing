...
public partial class FullAutoFormaA1L
{
    private AltDriver altDriver;
    private AutoFormaHelpersA1L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.
    ...
    public void OneTimeSetUp()
    {
        ...
        helpers = new AutoFormaHelpersA1L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaA1LWorkflow()
    {
        ExecuteFitLevel();
    ...
    private void ExecuteFitLevel()
    {
        ...
        // Pause for human verification, waiting for modification of signal file - Check that the correct template is loaded
