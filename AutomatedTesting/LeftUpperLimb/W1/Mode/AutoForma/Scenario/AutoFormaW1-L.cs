...
public partial class FullAutoFormaW1L
{
    ...
    private AutoFormaHelpersW1L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersW1L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaW1LWorkflow()
    {
        ExecuteFitLevel();
