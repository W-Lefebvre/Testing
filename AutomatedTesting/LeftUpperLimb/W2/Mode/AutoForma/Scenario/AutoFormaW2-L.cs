...
public partial class FullAutoFormaW2L
{
    ...
    private AutoFormaHelpersW2L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersW2L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaW2LWorkflow()
    {
        ExecuteFitLevel();
