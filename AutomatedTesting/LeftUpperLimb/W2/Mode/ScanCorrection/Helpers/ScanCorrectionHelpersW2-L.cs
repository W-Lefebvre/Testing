...
public partial class FullScanCorrectionW2L
{
    public class ScanCorrectionHelpersW2L
    {
        private AltDriver altDriver;

        public ScanCorrectionHelpersW2L(AltDriver driver)
        {
            altDriver = driver;
        }
        ...
        public void ClickSelectPartOfInterestArmLeftW2() => Click(986.0432f, 911.9858f);
