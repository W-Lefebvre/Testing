...
public partial class FullScanCorrectionW2L
{
    ...
    private ScanCorrectionHelpersW2L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new ScanCorrectionHelpersW2L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullScanCorrectionW2LWorkflow()
    {
        ExecuteCleanupLevel();
        ExecutePoseLevel();
        ExecuteThumbLevel();
    ...
    private void ExecuteCleanupLevel()
    {
        ...
        helpers.ClickSelectPartOfInterestArmLeftW2(); // Cannot use object here, use coordinate.
    ...
    private void ExecuteFullCleanupLevel()
    {
        ...
        helpers.ClickSelectPartOfInterestArmLeftW2();
        helpers.ClickQuitBtnObject();
