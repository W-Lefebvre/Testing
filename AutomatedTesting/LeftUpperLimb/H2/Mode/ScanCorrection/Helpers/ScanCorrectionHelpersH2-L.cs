...
public partial class FullScanCorrectionH2L
{
    public class ScanCorrectionHelpersH2L
    {
        private AltDriver altDriver;

        public ScanCorrectionHelpersH2L(AltDriver driver)
        {
            altDriver = driver;
        }
        ...
        public void ClickSelectPartOfInterestArmLeftH2() => Click(986.0432f, 911.9858f);
