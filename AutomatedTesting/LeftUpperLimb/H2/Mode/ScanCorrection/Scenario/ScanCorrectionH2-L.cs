...
public partial class FullScanCorrectionH2L
{
    ...
    private ScanCorrectionHelpersH2L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new ScanCorrectionHelpersH2L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullScanCorrectionH2LWorkflow()
    {
        ExecuteCleanupLevel();
        ExecutePoseLevel();
        ExecuteThumbLevel();
    ...
    private void ExecuteCleanupLevel()
    {
        ...
        helpers.ClickSelectPartOfInterestArmLeftH2(); // Cannot use object here, use coordinate.
    ...
    private void ExecuteFullCleanupLevel()
    {
        ...
        helpers.ClickSelectPartOfInterestArmLeftH2();
        helpers.ClickQuitBtnObject();
