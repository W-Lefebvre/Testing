...
public partial class FullAutoFormaH2L
{
    ...
    private AutoFormaHelpersH2L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersH2L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaH2LWorkflow()
    {
        ExecuteFitLevel();
