...
public partial class FullAutoFormaW3L
{
    ...
    private AutoFormaHelpersW3L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersW3L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaW3LWorkflow()
    {
        ExecuteFitLevel();
