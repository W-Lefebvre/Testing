...
public partial class FullAutoFormaA2L
{
    ...
    private AutoFormaHelpersA2L helpers; // Utiliser une instance des helpers pour accéder aux méthodes.

    [OneTimeSetUp]
    public void OneTimeSetUp()
    {
        altDriver = new AltDriver(host: ConnexionConfig.Host, port: ConnexionConfig.Port, appName: ConnexionConfig.AppName);
        helpers = new AutoFormaHelpersA2L(altDriver); // Initialisation avec le driver.
    }
    ...
    [Test]
    public void FullAutoFormaA2LWorkflow()
    {
        ExecuteFitLevel();
